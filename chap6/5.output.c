...
# 35 "5.max.c"
int main() {
    { printf("TEST: %s = %d\n", "MAX(2, 3)", ({ int __a = (2), __b = (3); __a > __b ? __a : __b; })); };
    { printf("TEST: %s = %d\n", "5 + MAX(2, 3)", 5 + ({ int __a = (2), __b = (3); __a > __b ? __a : __b; })); };
    { printf("TEST: %s = %d\n", "MAX(2, MAX(3, 4))", ({ int __a = (2), __b = (({ int __a = (3), __b = (4); __a > __b ? __a : __b; })); __a > __b ? __a : __b; })); };
    { printf("TEST: %s = %d\n", "MAX(2, 3 > 4 ? 3 : 4)", ({ int __a = (2), __b = (3 > 4 ? 3 : 4); __a > __b ? __a : __b; })); };


    int a = 7;
    { printf("TEST: %s = %d\n", "MAX(a++, 6)", ({ int __a = (a++), __b = (6); __a > __b ? __a : __b; })); };
